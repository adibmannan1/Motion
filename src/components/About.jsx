...
const About = () => {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="0.3" className='-mt-5 raleway w-full p-6 lg:px-20 lg:py-16 bg-[#559fff] rounded-tl-3xl rounded-tr-3xl'>
        ...
        <div className='w-full border-t-2 mt-16 border-blue-500 flex flex-col lg:flex-row pt-16 items-start justify-between'>
