...
const LandingPage = () => {
  ...
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-0.3" className='flex flex-col lg:flex-row pt-9 pb-14 lg:pb-0 lg:px-20 justify-between items-center w-full lg:h-screen bg-[#050711]'>
            ...
            {motos.map((moto, index) => (
                <div key={index} className="masker">
                    <div className='w-fit flex items-end overflow-hidden'>
                        ...
                        className='mr-[3.5vw] lg:mr-[1vw] rounded-[4px] lg:rounded-md w-[23vw] lg:w-[11vw] h-[13.4vw] lg:h-[5.5vw] bg-blue-500'>
